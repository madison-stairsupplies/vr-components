...
export var shadow = {
    ...
    tertiary: "rgba(50, 50, 93, 0.05) 0px 6px 8px -2px, rgba(0, 0, 0, 0.3) 0px 3px 5px -3px;",
...
export var border = {
    ...
    lightGray: "1px solid ".concat(colors.gray200),
    gray: "1px solid ".concat(colors.gray300),
    darkGray: "1px solid ".concat(colors.gray400),
    dotted: "1px dotted ".concat(colors.gray400),
};
var inputType = {
    number: "number",
    text: "text",
...
export var sprinkles = createSprinkles(responsiveProperties, colorProperties);
